...
export default function RestaurantCard(props) {
  ...
  let item, restaurant_name, _id, logo, branches, adress, menu;
  if (props.route) {
    item = props.route.params;
    menu = item.item.menu;
    restaurant_name = item.item.restaurant_name;
    logo = item.item.logo;
    branches = item.item.branches[0];
  ...
  return (
    ...
    >
      ...
      <Image
        source={
          {
            // uri: {logo? logo :"https://images.rawpixel.com/image_800/czNmcy1wcml2YXRlL3Jhd3BpeGVsX2ltYWdlcy93ZWJzaXRlX2NvbnRlbnQvbGlmZW9mcGl4MDAwMDEtaW1hZ2VfMS1renhsdXhhei5qcGc.jpg?s=gayymr-MoZkhATCpk4H6JF11q8zWqNV8pVstYoefMiE"},
          }
        }
